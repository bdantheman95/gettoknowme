...
# from ..app import GetToKnowBrandon
    ...
    4. Enter tethys test command.
       ...
       See below for specific examples
        ...
        To run all tests across this app:
            Test command: "tethys test -f tethys_apps.tethysapp.get_to_know_brandon"

        To run all tests in this file:
            Test command: "tethys test -f tethys_apps.tethysapp.get_to_know_brandon.tests.tests"

        To run tests in the GetToKnowBrandonTestCase class:
            Test command: "tethys test -f tethys_apps.tethysapp.get_to_know_brandon.tests.tests.GetToKnowBrandonTestCase"

        To run only the test_if_tethys_platform_is_great function in the GetToKnowBrandonTestCase class:
            Test command: "tethys test -f tethys_apps.tethysapp.get_to_know_brandon.tests.tests.GetToKnowBrandonTestCase.test_if_tethys_platform_is_great"
...
class GetToKnowBrandonTestCase(TethysTestCase):
    """
    ...
    def set_up(self):
        ...
        test database creation function here, like so:
            ...
            self.create_test_persistent_stores_for_app(GetToKnowBrandon)
    ...
    def tear_down(self):
        ...
        stores, you should call the test database destruction function from here, like so:
            ...
            self.destroy_test_persistent_stores_for_app(GetToKnowBrandon)
    ...
    def test_home_controller(self):
        ...
        response = c.get('/apps/get-to-know-brandon/')  # The final '/' is essential for all pages/controllers
